...
export default class LefosseWebPart extends BaseClientSideWebPart<ILefosseWebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<ILefosseProps> = React.createElement(Lefosse, {
